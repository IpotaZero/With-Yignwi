const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./SceneGame-Bxgpe8vR.js","../run.js","./ScenePretitle-Dpod3Db0.js","./SceneNovel-Bsyx4A9E.js"])))=>i.map(i=>d[i]);
import{D as u,B as m,_ as y,S as d}from"../run.js";import{S as w,p as E}from"./ScenePretitle-Dpod3Db0.js";class r{static allClear(){for(let e=0;e<30;e++)this.setData(e,{cleared:!0,leastCleared:!1})}static getData(){const e=localStorage.getItem("data");return e?JSON.parse(e):this.#e()}static setData(e,t){const a=this.getData();a[e].cleared||=t.cleared,a[e].leastCleared||=t.leastCleared,localStorage.setItem("data",JSON.stringify(a))}static#e(){return Array.from({length:6},()=>Array.from({length:5},()=>({cleared:!1,leastCleared:!1}))).flat()}static getBGMVolume(){return+(localStorage.getItem("bgm-volume")??"1")}static setBGMVolume(e){localStorage.setItem("bgm-volume",""+e)}static getSEVolume(){return+(localStorage.getItem("se-volume")??"1")}static setSEVolume(e){localStorage.setItem("se-volume",""+e)}}window.LocalStorage=r;const v=new Image;v.src="assets/images/maple.png";function M(i){const e=document.createElement("style");e.innerHTML=`
        .falling-particle {
            position: fixed;
            pointer-events: none;
